...
<p>This artifact is most prominent in electrode E55 between the REF and COM electrodes, but is also visible in surrounding channels. It is time-locked to both stimulus onset and offset, presenting as a negative deflection at onset and a positive deflection at offset, as highlighted in the following EEG trace. Please visit <a href="artifacts" target="_blank">this page</a> to see how this artifact appears in time-frequency plots.</p>
