...
Note that Basic Demographics data (<code>sed_basic_demographics.tsv</code>) includes an additional set of fields reporting age - please see [Basic Demmographics](../measures/demographics.md) for more information. The following fields report age at the time of instrument administration:
<p>
