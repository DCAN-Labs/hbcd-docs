...
<div class="notification-collapsible-content">
<p>HBCD study protocols are available in the Scientist section of the main <a href="https://hbcdstudy.org/study-protocols/">HBCD Study website</a>. However, please note that we are generally unable to share the specific measures used outside of the study, as many are proprietary. General information about the questions asked and corresponding answer options can be explored with DEAP and the Lasso Query Tool (<a href="../../access/download/#explore-data">see details</a>) and additional details/resources are available in measure descriptions provided in the <a href="../../measures/">study instrument documentation</a>. For further details on the protocol development, please refer to the <a href="https://www.sciencedirect.com/special-issue/10VNSS1BBLV">special issue of Developmental Cognitive Neuroscience</a> dedicated to the HBCD Study.</p>
</div>
</p>
