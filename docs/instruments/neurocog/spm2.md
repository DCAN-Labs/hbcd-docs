...
<td style="word-wrap: break-word; white-space: normal;">Subject matter expert periodically reviews data capture to ensure that items are being fully completed and scoring is spot-checked to assure algorithms are being correctly employed.</td></tr>
</tbody>
</table>
